...
$(function() {
    ...
    */
    ...
    describe('The menu', () => {
        ...
        /* TODO: Write a test (SPEC) that ensures the menu element is
    ...
    describe('Initial Entries', () => {
        ...
        it('have at least one entry after the loadFeed function is done', (done) => {
    ...
    describe('New Feed Selection', () => {
        ...
        it('have changed the content in the website', (done) => {
